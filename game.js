...
preload.prototype = 
    {
        preload: function()
            { 
                ...
                game.load.image("ship", "assets/sprites/dojo.png");
                ...
                game.load.image("dojoLogo", "assets/sprites/dojo_small_banner.png");
...
titleScreen.prototype = {  
    create: function()
    {
        ...
        var logo = game.add.image(game.width - 182, game.height - 57, "dojoLogo");
        ...
        create: function() 
            {
                ...
                game.add.bitmapText(game.width / 2, 400, "font", "Move to bottom", 60).anchor.x = 0.5;
                game.add.bitmapText(game.width / 2, 480, "font", "Swipe, Drag, or SHIFT key", 36).anchor.x = 0.5;
                
                var horizontalShip = game.add.sprite(game.width / 2 - 100, 280, "ship");
                ...
                var verticalShipTweem = game.add.tween(verticalShip).to(
                {
                    y: 640
                }, 700, "Linear", true, 0 , -1);
        ...
        create: function()
            {
                ...
                var tunnelLogo = game.add.image(game.width / 2, game.height - 57, "dojoLogo");
                tunnelLogo.scale.set(0.3);
                tunnelLogo.anchor.set(0.5);
    ...
    create: function() 
        {
            ...
            game.add.bitmapText(game.width / 2, game.height - 300, "font", "Play Again?", 32).anchor.x = 0.5;
