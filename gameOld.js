...
playGame.prototype = {
    ...
    create: function() {
        ...
        this.verticalTween = game.add.tween(this.ship).to({y: 0}, shipVerticalSpeed, Phaser.Easing.Linear.None, true);
    ...
    moveship: function() {
        ...
        if (this.ship.canMove) {
            ...
            var ghostTween = game.add.tween(ghostShip).to({alpha:0}, 350, Phaser.Easing.Linear.None, true);
...
Barrier = function (game, speed, tintColor) {
    ...
    var cropRect = new Phaser.Rectangle(0, 0, tunnelWidth / 4, 24);
    this.crop(cropRect);
